"use client";
import { Layout, ProfileMenu, ViewportIcon } from "@repo/ui";
...
export const LayoutMenu = ({ children, pageTitleKey }: LayoutMenuProps) => {
  ...
  // const [currentUser, setCurrentUser] = useState<MeData>();
  ...
  const links = [
    {
      href: "/",
      label: label("molecules.layout.menu.viewport", "##PM-MPE Portal"),
      icon: <ViewportIcon />,
    },
  ];
  ...
  return (
    <Layout
      appTitle={label("navigation.title.viewport", "##PortView")}
      links={links}
