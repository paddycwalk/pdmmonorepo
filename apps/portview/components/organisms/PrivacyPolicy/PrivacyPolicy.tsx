...
import { notifier, Panel } from "@repo/ui";
...
const PrivacyPolicy = (): React.ReactElement => {
  ...
  useEffect(() => {
    let dataUrl;
    const dataUrlDE = `${VIEWPORT_API_URL}privacyPolicy/de-DE?app=portal`;
    const dataUrlEN = `${VIEWPORT_API_URL}privacyPolicy/en-GB?app=portal`;
